...
The following actions remain relevant for later risk-profile improvement:
...
- Transaction hash for liquidity-lock deployment.
- Transaction hash(es) for transferring the LP NFTs into the liquidity-lock contract.
- `ownerOf()` evidence showing both LP NFTs are held by the liquidity-lock contract.
- Transaction hash for `renounceOwnership()`: `0x22a11b6fc6e24d98f97e73a0fb9845db8a2996955962567af592f4c5e0211d04`.
- Whitepaper link.
